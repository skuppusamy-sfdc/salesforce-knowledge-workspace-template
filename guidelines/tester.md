...
>
> **Companion skill:** `.cursor/skills/qa-test-scenarios/SKILL.md` — the AI auto-invokes this skill when the user asks to plan tests, generate scenarios, validate AC coverage, identify edge cases, or plan regression. The skill and this guideline describe the same workflow; this file is for humans, the skill is for the bot. Keep them aligned when editing.
...
- "Which Copado stories are linked to [JIRA-Story-ID]?"
