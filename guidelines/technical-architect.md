...
>
> **Companion skill:** `.cursor/skills/ta-historic-context/SKILL.md` — the AI auto-invokes this skill when the user asks to design, review, or augment a technical solution for a JIRA story. The skill and this guideline describe the same workflow; this file is for humans, the skill is for the bot. Keep them aligned when editing.
...
2. **Pull Historic Context** — prior stories on the same components, prior architectural decisions
