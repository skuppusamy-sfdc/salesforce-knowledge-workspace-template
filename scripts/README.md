...
**Input**: `knowledge/sprints/Sprint N/SCP [HC] Sprint N.html`
**Output**: `knowledge/sprints/Sprint N/stories/PR1050558-XXXX.md` (one file per story)
...
**Fix**: Ensure HTML files are named like `SCP HC Sprint 14.html` or `SCP Sprint 12.html`
